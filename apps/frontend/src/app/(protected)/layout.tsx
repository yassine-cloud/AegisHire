...
export default async function ProtectedLayout({
  ...
  // In Supabase, if confirmed email is required but they haven't confirmed, 
  // they might not have email_confirmed_at set, or might not even get a session.
  // If they have a session but it's not confirmed:
